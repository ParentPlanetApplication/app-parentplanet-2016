    ...
    */
    ...
    var processResponses = function() {
        ...
        var addOldEvents = function(groupId, parentIdArray, parentObjectArray) {
                ...
                success: function(results) {
                    $.each(results, function(i, event) {
                        for (var m = 0; m < parentIdArray.length; m++) {
                            ...
                            isUserEventRelationExist(parentId, childIdList, eventId, groupType, groupId);
            ...
            var createUserEventRelation = function(parentId, childIdList, eventId, groupType, groupId) {
            ...
            var isUserEventRelationExist = function(parentId, childIdList, eventId, groupType, groupId) {
                var UserEventRelation = Parse.Object.extend("UserEventRelation", {}, {
                    query: function() {
                        return new Parse.Query(this.className);
                    }
                ...
                query.find({
                    success: function(results) {
                        if (results.length > 0) {
                            ...
                            createUserEventRelation(parentId, childIdList, eventId, groupType, groupId);
                        }
                    },
                    error: function(error) {
                        alert('Error: ' + JSON.stringify(error));
