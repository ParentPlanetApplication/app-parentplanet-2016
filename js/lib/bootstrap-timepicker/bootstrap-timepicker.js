...
(function($, window, document, undefined) {
  ...
  Timepicker.prototype = {
    ...
    _init: function() {
      ...
      this.$element.parent('.field').find('.icon-clock').on({
        'click.timepicker': $.proxy(this.showWidget, this)
      });
      this.$element.parent('.field').find('.icon-calendar').on({
        'click': $.proxy(this.hideWidget, this)
      });
      this.$element.parent('.field').find('.pickadate__input').on({
        'focus': $.proxy(this.hideWidget, this)
      });
    ...
    place : function() {
      ...
      // add positions together to account for webapp being centered (using offset moves timepicker to the right side of the entire document, instead of the body)
      var fieldPosition = this.$element.closest(".field").position();
      var arrowPosition = this.$element.closest(".right-arrow").position();
      var timePosition = this.$element.position();
      var height = this.component ? this.component.outerHeight(true) : this.$element.outerHeight(false);
      var width = this.component ? this.component.outerWidth(true) : this.$element.outerWidth(false);
      var left = fieldPosition.left + arrowPosition.left + timePosition.left, top = offset.top;
