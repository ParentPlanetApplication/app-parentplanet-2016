var vcard = function() {
    ...
    if (navigator.userAgent.indexOf('MSIE') > -1 && navigator.userAgent.indexOf('MSIE 10') == -1) {
        console.log('Unsupported Browser for vcard');
        return;
    }
    ...
    generate_fn = function(json) {
        var k, string = BLANK, v, _ref;
        if (json.group) { string += BLANK + json.group + PERIOD;  }
        string += 'FN';
        if (json.params) {
            _ref = json.params;
            for (k in _ref) {
    ...
    var generate = function(json) {
        var adr, email, k, klass, label, logo, note, org, photo, role, sound, string = BLANK, tel, title, url, v, _i, _j, _k, _l, _len, _len1, _len10, _len11, _len12, _len2, _len3, _len4, _len5, _len6, _len7, _len8, _len9, _m, _n, _o, _p, _q, _r, _ref, _ref1, _ref10, _ref11, _ref12, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9, _s, _t, _u;
