cordova.define("org.transistorsoft.cordova.plugin.background.fetch.BackgroundFetch", function(require, exports, module) { /***
...
module.exports = {
    ...
    */
    ...
    configure: function(callback, failure, config) {
        ...
        config = config || [0]; //sxm provide optional interval in seconds
