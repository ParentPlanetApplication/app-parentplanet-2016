...
static NSMutableString *logMessage;

static NSURLRequest *s_lastRequest;

@implementation CDVWebViewDelegate

- (id)initWithDelegate:(NSObject <UIWebViewDelegate>*)delegate
{
    logMessage = [NSMutableString stringWithString:@"Start initWithDelegate"];
    self = [super init];
    if (self != nil) {
        _delegate = delegate;
        _loadCount = -1;
...
- (BOOL)webView:(UIWebView*)webView shouldStartLoadWithRequest:(NSURLRequest*)request navigationType:(UIWebViewNavigationType)navigationType
{
    ...
    [logMessage appendString:@"\nStart shouldStartLoadWithRequest"];
    [logMessage appendString:@"\nrequest: "];
    [logMessage appendString:[[request URL] absoluteString]];
    ...
    [logMessage appendString:@"\nshouldLoad: "];
    [logMessage appendString:shouldLoad? @"YES": @"NO"];
    if (shouldLoad) {
    ...
    [logMessage appendFormat:@"\n Current state = %d", _state];
    [logMessage appendString:@"\nEnd shouldStartLoadWithRequest"];
    return shouldLoad;
}
...
{
    [logMessage appendFormat:@"\n Start didFailLoadWithError %d", [error code]];
    ...
    if ([error code] == -1001) {
        ...
        */
        ...
        [webView loadRequest:s_lastRequest];
    }
}
