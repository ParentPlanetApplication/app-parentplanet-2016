...
static NSMutableString *s_vcLog;
static UIWebView *s_webView;
...
- (void)__init
{
    s_vcLog = [NSMutableString stringWithString:@"Start INIT"];
...
- (NSURL*)appUrl
{
    ...
    [s_vcLog appendString:@"\nEnd appURL: "];
    if (appURL != nil) {
        [s_vcLog appendString:[appURL absoluteString]];
    } else {
        [s_vcLog appendString:@"nil"];
    }
...
- (void)viewDidLoad
{
    ...
    [CDVUserAgentUtil acquireLock:^(NSInteger lockToken) {
        ...
        if (appURL) {
           [s_vcLog appendString:@"\nLoading appURL:"];
           [s_vcLog appendString:[appURL absoluteString]];
            NSURLRequest* appReq = [NSURLRequest requestWithURL:appURL cachePolicy:NSURLRequestUseProtocolCachePolicy timeoutInterval:5];
            //NSURLRequest* appReq = [NSURLRequest requestWithURL:[NSURL URLWithString:@"https://app.parentplanet.com/index.html"] cachePolicy:NSURLRequestUseProtocolCachePolicy timeoutInterval:1];
...
- (void)webViewDidStartLoad:(UIWebView*)theWebView
{
    ...
    NSLog(@"+++Resetting plugins done.");
    [s_vcLog appendString:@"\nEnd webViewDidStartLoad"];
}
...
- (void)webViewDidFinishLoad:(UIWebView*)theWebView
{
    ...
    [s_vcLog appendString:@"\nEnd webViewDidFinishLoad"];
}

- (void)webView:(UIWebView*)theWebView didFailLoadWithError:(NSError*)error
{
    [s_vcLog appendFormat:@"\nStart didFailLoadWithError %@", [error localizedDescription]];
    [CDVUserAgentUtil releaseLock:&_userAgentLockToken];
