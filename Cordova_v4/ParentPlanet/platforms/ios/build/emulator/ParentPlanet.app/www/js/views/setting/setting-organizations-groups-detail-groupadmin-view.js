define([
    'chaplin',
    'views/base/view',
    'text!templates/setting/setting-organizations-groups-detail-groupadmin-view.hbs',
    'jquery',
    'spinner',
    'parse'
    ...
    var loadStaffs = function() {
        ...
        query.find({
            success: function(results) {
                ...
                if (results.length == 0) {
                    $("#content").append('<div style="text-align:center;padding: 5px 10px 0 10px;">No admin found</div>');
                } else {
