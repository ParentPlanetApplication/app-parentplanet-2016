...
Calendar.prototype.modifyRepeatEventInstance = function (syncId, oldStartDate, oldEndDate, calendar, isCanceled, title, location, notes, startDate, endDate, firstReminderMinutes, secondReminderMinutes, successCallback, errorCallback) {
    ...
    {
        "syncId": syncId,
        "oldStartTime": oldStartDate instanceof Date ? oldStartDate.getTime() : null,
        "oldEndTime": oldStartDate instanceof Date ? oldStartDate.getTime() + 1 : null,
        "calendar": calendar,
        ...
        "startTime": startDate instanceof Date ? startDate.getTime() : null,
        "endTime": endDate instanceof Date ? endDate.getTime() : null,
        "firstReminderMinutes": isNaN(firstReminderMinutes) ? null : firstReminderMinutes,
        "secondReminderMinutes": isNaN(secondReminderMinutes) ? null : secondReminderMinutes
    }]);
};
